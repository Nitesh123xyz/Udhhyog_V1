...
const LeadsAdditionalDetailsHeader = ({
  ...
  return (
    <div className="bg-[var(--background)] backdrop-blur-md border-b border-[var(--border)] rounded-t-lg w-full flex items-center justify-between px-1.5 py-1.5 mb-1.5 transition-all duration-300">
      <div className="flex items-center gap-3">
        ...
        <h2 className="flex items-center gap-4 text-[var(--text)] uppercase text-sm lg:text-lg">
          {step === 2 ? "Additional Details" : "Update Vendor"}
        </h2>
      </div>
      <div className="flex">
