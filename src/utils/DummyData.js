export const dummyData = [
  ...
  {
    name: "Rahul Patel",
    permissions: { view: true, edit: true, add: true, del: true, all: true },
  },
];
...
export const employeesHeading = [
  ...
  { name: "Job Title", status: false },
  { name: "Department", status: false },
  { name: "Salary", status: true },
  { name: "Start Date", status: true },
  { name: "Lifecycle", status: false },
  { name: "Status", status: false },
  { name: "Actions", status: false },
];
